...
const Login = () => {
  ...
  return (
    <>
      {!user ? (
        <div className='text-center h-screen flex flex-col gap-4 items-center my-3 '>
          ...
          <h2 className='font-light text-center my-2 text-3xl'>Sign in</h2>
          <form onSubmit={userLogin} className='max-w-sm '>
            <label>Email</label>
            <input
